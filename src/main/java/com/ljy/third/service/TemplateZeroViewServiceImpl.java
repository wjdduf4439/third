...
public class TemplateZeroViewServiceImpl implements TemplateZeroViewService {
	...
	public List<TemplateViewInfoVO> selectTableFieldList(TemplateViewInfoVO templateViewInfoVO) throws Exception {
		...
		System.out.println("������ �������ε��� : " + templateViewInfoVO.getPageIndex());
		System.out.println("������ ���ڵ�ī��Ʈ : " + templateViewInfoVO.getRecordCountPerPage());
		
		templateViewInfoVO.setPageIndex( templateViewInfoVO.getPageIndex() * templateViewInfoVO.getRecordCountPerPage() );
