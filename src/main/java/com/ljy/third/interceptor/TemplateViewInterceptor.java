...
@Component
public class TemplateViewInterceptor implements HandlerInterceptor { 
		...
		*/
		...
		@Override
   		public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
			...
			TemplateViewInfoVO tableViewInfo = new TemplateViewInfoVO(); tableViewInfo.setSiteCode(request.getParameter("siteCode"));
			TemplateViewInfoVO tableName = templateInfoService.selectTableName(tableViewInfo);
			...
			request.setAttribute("templateViewInfoVO", tableName);
